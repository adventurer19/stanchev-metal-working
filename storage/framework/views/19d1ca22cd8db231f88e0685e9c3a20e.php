...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'ВИКТОР-КММ ООД - Прецизна металообработка'); ?></title>
...
<body class="antialiased bg-slate-950 text-slate-100">
    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-500 glass border-b border-slate-800/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    <a href="#home" class="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('Начало')); ?></a>
                    <a href="#craft" class="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('За нас')); ?></a>
                    <a href="#portfolio" class="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('Портфолио')); ?></a>
                    <a href="#why-us" class="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('Защо ние')); ?></a>
                    <a href="#contact" class="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('Контакти')); ?></a>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden glass border-t border-slate-800/50">
            <div class="px-4 py-4 space-y-2">
                <a href="#home" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('Начало')); ?></a>
                <a href="#craft" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('За нас')); ?></a>
                <a href="#portfolio" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('Портфолио')); ?></a>
                <a href="#why-us" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('Защо ние')); ?></a>
                <a href="#contact" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-lg transition-all duration-300"><?php echo e(__('Контакти')); ?></a>
            </div>
        </div>
    </nav>
    ...
    <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        <div class="absolute inset-0 z-0">
            ...
            <img src="<?php echo e(asset('images/' . $heroImage)); ?>" alt="Metalworking" class="w-full h-full object-cover opacity-20">
        ...
        <div class="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto animate-fade-in">
            <div class="inline-block mb-6 px-4 py-2 bg-accent-500/10 border border-accent-500/20 rounded-full">
                <span class="text-sm font-semibold text-accent-400"><?php echo e(__('От 2007 година')); ?></span>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-20">
                <h2 class="section-title">
                    <?php echo e(__('Нашето майсторство')); ?>

                </h2>
                <p class="section-subtitle">
                    <?php echo e(__('Специализирани сме в прецизна металообработка, като предоставяме персонализирани услуги и продукти с високо качество и внимание към детайла.')); ?>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center mb-20">
                <div class="space-y-6">
                    <div class="card card-hover">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('Прецизност и качество')); ?></h3>
                                <p class="text-slate-400 leading-relaxed">
                                    <?php echo e(__('Всяка детайл е изработен с внимание към перфектността. Използваме модерни технологии и строг контрол на качеството.')); ?>
                    ...
                    <div class="card card-hover">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('Иновации и технологии')); ?></h3>
                                <p class="text-slate-400 leading-relaxed">
                                    <?php echo e(__('Работим с най-модерните технологии и машини за най-добри резултати. Постоянно инвестираме в ново оборудване.')); ?>
                    ...
                    <div class="card card-hover">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('Опитен екип')); ?></h3>
                                <p class="text-slate-400 leading-relaxed">
                                    <?php echo e(__('Нашият екип има дългогодишен опит в металообработката и отговаря на нуждите на клиенти от различни индустрии.')); ?>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    ?>
                    <?php $__currentLoopData = $craftImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="<?php echo e($index === 0 ? 'col-span-2' : ''); ?> group relative overflow-hidden rounded-xl border border-slate-800/50 hover:border-accent-500/50 transition-all duration-500">
                            <div class="aspect-square overflow-hidden">
                                <img src="<?php echo e(asset('images/' . $img)); ?>" alt="Craft <?php echo e($index + 1); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <?php $__currentLoopData = $portfolioImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group relative overflow-hidden rounded-xl border border-slate-800/50 bg-slate-900/50 cursor-pointer transform transition-all duration-500 hover:scale-[1.02] hover:border-accent-500/50 hover:shadow-2xl hover:shadow-accent-500/20">
                        <div class="aspect-square overflow-hidden">
                            <img src="<?php echo e(asset('images/' . $img)); ?>" alt="Project <?php echo e($index + 1); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        </div>
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                            <div class="absolute bottom-0 left-0 right-0 p-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                                <h3 class="text-white font-bold text-lg mb-2"><?php echo e(__('Проект')); ?> <?php echo e($index + 1); ?></h3>
    ...
    <section id="why-us" class="py-32 bg-slate-950 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-20">
                <h2 class="section-title">
                    <?php echo e(__('Защо да изберете нас?')); ?>

                </h2>
                <p class="section-subtitle">
                    <?php echo e(__('Разбираме, че успехът на вашия бизнес зависи от качеството и надеждността на вашите партньори.')); ?>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="card card-hover text-center">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-4"><?php echo e(__('Прецизност')); ?></h3>
                    <p class="text-slate-400 leading-relaxed">
                        <?php echo e(__('Всяка детайл е изработен с внимание към перфектността и качеството.')); ?>
                ...
                <div class="card card-hover text-center">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-4"><?php echo e(__('Модерно оборудване')); ?></h3>
                    <p class="text-slate-400 leading-relaxed">
                        <?php echo e(__('Работим с най-модерните технологии и машини за най-добри резултати.')); ?>
                ...
                <div class="card card-hover text-center">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-4"><?php echo e(__('Опитен екип')); ?></h3>
                    <p class="text-slate-400 leading-relaxed">
                        <?php echo e(__('Нашият екип има дългогодишен опит в металообработката.')); ?>
    ...
    <section id="contact" class="py-32 bg-slate-900 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-20">
                <h2 class="section-title">
                    <?php echo e(__('Свържете се с нас')); ?>

                </h2>
                <p class="section-subtitle">
                    <?php echo e(__('Готови сте да направите следващата стъпка? Нашият екип е тук, за да отговори на вашите нужди.')); ?>

                </p>
            </div>
            <div class="grid lg:grid-cols-2 gap-12">
                <div class="card">
                    <form action="<?php echo e(route('contact')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <div>
                    ...
                    <div class="card">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <p class="text-slate-300 font-semibold mb-1"><?php echo e(__('Адрес')); ?></p>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <p class="text-slate-300 font-semibold mb-1"><?php echo e(__('Телефон')); ?></p>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <p class="text-slate-300 font-semibold mb-1"><?php echo e(__('Имейл')); ?></p>
    ...
    <footer class="bg-slate-950 border-t border-slate-800/50 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <p class="text-slate-400 mb-2">© <?php echo e(date('Y')); ?> <span class="text-gradient font-semibold">ВИКТОР-КММ ООД</span>. <?php echo e(__('Всички права запазени')); ?></p>
                <p class="text-slate-500 text-sm"><?php echo e(__('Прецизна металообработка и индустриални решения')); ?></p>
            </div>
        </div>
    </footer>
