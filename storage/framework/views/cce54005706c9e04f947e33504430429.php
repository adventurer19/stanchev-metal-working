            ...
            <?php $__currentLoopData = $portfolioImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card card-hover group relative overflow-hidden p-0 cursor-pointer">
                    ...
                    <div class="aspect-square overflow-hidden relative">
                        <img src="<?php echo e(asset($img['src'])); ?>" alt="<?php echo e($img['title']); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                        
                        <!-- Background image effect -->
                        <div class="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                            <img src="<?php echo e(asset($img['src'])); ?>" alt="" class="w-full h-full object-cover blur-xl scale-110">
                        </div>
                        ...
                        <div class="absolute inset-0 flex flex-col justify-end p-6 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                            <div class="relative z-10">
                                ...
                                <h3 class="text-white font-bold text-xl mb-2"><?php echo e($img['title']); ?></h3>
                    ...
                    <div class="p-4 bg-slate-900/80 backdrop-blur-sm border-t border-slate-800/50">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-white font-semibold text-base mb-1"><?php echo e($img['title']); ?></h3>
                                <p class="text-slate-400 text-xs"><?php echo e(__('Металообработка')); ?></p>
                            </div>
