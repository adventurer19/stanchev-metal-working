...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="<?php echo e(asset('favicon-optimized.svg')); ?>">
    <link rel="alternate icon" href="<?php echo e(asset('favicon-optimized.svg')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('favicon-optimized.svg')); ?>">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    <a href="<?php echo e(route('home')); ?>" class="px-4 py-2 text-sm font-medium <?php echo e(request()->routeIs('home') ? 'text-accent-400 bg-slate-800/50' : 'text-slate-300 hover:text-white hover:bg-slate-800/50'); ?> rounded-sm transition-all duration-300"><?php echo e(__('Начало')); ?></a>
                    <a href="<?php echo e(route('about')); ?>" class="px-4 py-2 text-sm font-medium <?php echo e(request()->routeIs('about') ? 'text-accent-400 bg-slate-800/50' : 'text-slate-300 hover:text-white hover:bg-slate-800/50'); ?> rounded-sm transition-all duration-300"><?php echo e(__('За нас')); ?></a>
                    <a href="<?php echo e(route('portfolio')); ?>" class="px-4 py-2 text-sm font-medium <?php echo e(request()->routeIs('portfolio') ? 'text-accent-400 bg-slate-800/50' : 'text-slate-300 hover:text-white hover:bg-slate-800/50'); ?> rounded-sm transition-all duration-300"><?php echo e(__('Портфолио')); ?></a>
                    <a href="<?php echo e(route('why-us')); ?>" class="px-4 py-2 text-sm font-medium <?php echo e(request()->routeIs('why-us') ? 'text-accent-400 bg-slate-800/50' : 'text-slate-300 hover:text-white hover:bg-slate-800/50'); ?> rounded-sm transition-all duration-300"><?php echo e(__('Защо ние')); ?></a>
                    <a href="<?php echo e(route('contact')); ?>" class="px-4 py-2 text-sm font-medium <?php echo e(request()->routeIs('contact') ? 'text-accent-400 bg-slate-800/50' : 'text-slate-300 hover:text-white hover:bg-slate-800/50'); ?> rounded-sm transition-all duration-300"><?php echo e(__('Контакти')); ?></a>
                </div>
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-1 bg-slate-900/50 rounded-sm p-1 border border-slate-800">
                        <a href="<?php echo e(route('locale', 'bg')); ?>" class="px-3 py-1.5 text-xs font-medium rounded-sm transition-all duration-300 <?php echo e(app()->getLocale() === 'bg' ? 'bg-accent-500 text-white shadow-lg shadow-accent-500/30' : 'text-slate-400 hover:text-slate-200'); ?>">БГ</a>
                        <a href="<?php echo e(route('locale', 'en')); ?>" class="px-3 py-1.5 text-xs font-medium rounded-sm transition-all duration-300 <?php echo e(app()->getLocale() === 'en' ? 'bg-accent-500 text-white shadow-lg shadow-accent-500/30' : 'text-slate-400 hover:text-slate-200'); ?>">EN</a>
                    </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden fixed top-0 left-0 h-full w-64 bg-slate-900/95 backdrop-blur-xl border-r border-slate-800/50 z-50" style="left: 0; right: auto; transform: translateX(-100%); transition: transform 0.3s ease-in-out; will-change: transform;">
        <div class="flex flex-col h-full">
            ...
            <div class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                <a href="<?php echo e(route('home')); ?>" class="block px-4 py-3 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('Начало')); ?></a>
                <a href="<?php echo e(route('about')); ?>" class="block px-4 py-3 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('За нас')); ?></a>
                <a href="<?php echo e(route('portfolio')); ?>" class="block px-4 py-3 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('Портфолио')); ?></a>
                <a href="<?php echo e(route('why-us')); ?>" class="block px-4 py-3 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('Защо ние')); ?></a>
                <a href="<?php echo e(route('contact')); ?>" class="block px-4 py-3 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('Контакти')); ?></a>
            </div>
        </div>
    </div>
                ...
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <h3 class="text-sm font-semibold text-white"><?php echo e(__('Използваме бисквитки')); ?></h3>
                        </div>
                        <p class="text-sm text-slate-300 leading-relaxed">
                            <?php echo e(__('Този сайт използва бисквитки, за да подобри вашето потребителско изживяване. Като продължавате да използвате сайта, вие се съгласявате с използването на бисквитки.')); ?>
