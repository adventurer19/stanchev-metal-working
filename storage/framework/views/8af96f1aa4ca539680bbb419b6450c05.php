    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-500 glass border-b border-slate-800/50">
        ...
        <div id="mobile-menu" class="hidden md:hidden glass border-t border-slate-800/50">
            <div class="px-4 py-4 space-y-2">
                <a href="<?php echo e(route('home')); ?>" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('Начало')); ?></a>
                <a href="<?php echo e(route('about')); ?>" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('За нас')); ?></a>
                <a href="<?php echo e(route('portfolio')); ?>" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('Портфолио')); ?></a>
                <a href="<?php echo e(route('why-us')); ?>" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('Защо ние')); ?></a>
                <a href="<?php echo e(route('contact')); ?>" class="block px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800/50 rounded-sm transition-all duration-300"><?php echo e(__('Контакти')); ?></a>
            </div>
        </div>
    </nav>
