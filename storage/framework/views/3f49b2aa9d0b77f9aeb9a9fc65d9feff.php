<?php $__env->startSection('title', __('Контакти - Станчев и Син 2025 ЕООД')); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-8">
                ...
                <div class="card">
                    <h3 class="text-2xl font-bold text-white mb-4"><?php echo e(__('Работно време')); ?></h3>
                    <div class="space-y-2 text-slate-400">
                        <p class="flex justify-between">
                            <span><?php echo e(__('Понеделник - Петък')); ?></span>
                            <span>08:00 - 17:00</span>
                        </p>
                        <p class="flex justify-between">
                            <span><?php echo e(__('Събота')); ?></span>
                            <span><?php echo e(__('По уговорка')); ?></span>
                        </p>
                        <p class="flex justify-between">
                            <span><?php echo e(__('Неделя')); ?></span>
                            <span><?php echo e(__('Почивен ден')); ?></span>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="relative w-full h-96 rounded-b-sm overflow-hidden bg-slate-800 group">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center bg-slate-900/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-b-sm">
                        <a href="https://www.google.com/maps/search/?api=1&query=Столетов+162,+Габрово,+България" 
                           ...
                           class="btn-primary">
                            <?php echo e(__('Отвори в Google Maps')); ?>
