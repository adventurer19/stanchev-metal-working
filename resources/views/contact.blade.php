...
@section('title', __('Контакти | Станчев и Син | Металообработка Габрово'))
@section('description', __('Свържете се със Станчев и Син за оферта. Тел: +359 77855070, Email: stanchev_sin2025@abv.bg. Габрово, бул. Столетов 162. Пон-Пет 8-17ч.'))
@section('keywords', __('Станчев и Син контакти, металообработка Габрово, телефон, оферта, адрес'))
