...
@section('title', __('Контакти Габрово | Свържете се с нас | Станчев и Син'))
@section('description', __('Свържете се с нас за оферта. Телефон: +359 77855070, Email: stanchev_sin2025@abv.bg. Адрес: Габрово, бул. Столетов 162. Работно време: Пон-Пет 8-17ч.'))
@section('keywords', __('контакти металообработка, телефон Габрово, оферта заваряване, адрес Станчев и Син'))
