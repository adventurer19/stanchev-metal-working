...
@section('title', __('Защо да изберете нас | Качество и опит | Станчев и Син'))
@section('description', __('Открийте защо водещи компании избират нас за металообработка. Прецизност, навременни доставки и 15+ години опит в индустрията. Заявете оферта сега!'))
@section('keywords', __('защо да изберете, качество металообработка, надеждна фирма, професионални услуги, опитен екип'))
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div class="card card-hover">
                <h3 class="text-2xl font-bold text-white mb-4">{{ __('Гарантирано качество') }}</h3>
                <p class="text-slate-400 leading-relaxed mb-4">
                    {{ __('Всяка работа преминава през строг контрол на качеството, за да гарантираме перфектни резултати.') }}
                </p>
                <ul class="space-y-2 text-slate-400">
                    <li class="flex items-center">
                        ...
                        {{ __('Строг контрол на качеството') }}
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 text-accent-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        {{ __('Сертифицирани процеси') }}
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 text-accent-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        {{ __('Гаранция за всички проекти') }}
                    </li>
                </ul>
            </div>
            <div class="card card-hover">
                <h3 class="text-2xl font-bold text-white mb-4">{{ __('Персонализирани решения') }}</h3>
                <p class="text-slate-400 leading-relaxed mb-4">
                    {{ __('Работим в тясно сътрудничество с клиентите, за да създадем решения, които отговарят на техните специфични нужди.') }}
                </p>
                <ul class="space-y-2 text-slate-400">
                    <li class="flex items-center">
                        <svg class="w-5 h-5 text-accent-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {{ __('Консултации и съвети') }}
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 text-accent-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        {{ __('Персонализиран дизайн') }}
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 text-accent-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
