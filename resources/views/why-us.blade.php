...
@section('title', __('Защо да изберете Станчев и Син | Металообработка Габрово'))
@section('description', __('Защо да изберете Станчев и Син за металообработка? 15+ години опит, прецизност, навременни доставки, индивидуален подход. Заявете оферта!'))
@section('keywords', __('Станчев и Син, защо да изберете, металообработка Габрово, качество, прецизност, опитен екип'))
