...
@section('title', __('Металообработка Плевен | Заваряване, ЦНЦ | Станчев и Син'))
@section('description', __('Прецизна металообработка в Плевен. 15+ години опит в заваряване, фрезоване, ЦНЦ обработка и производство на метални конструкции. Гарантирано качество.'))
@section('keywords', __('металообработка Плевен, заваряване, фрезоване, ЦНЦ обработка, метални конструкции, Станчев и Син'))
