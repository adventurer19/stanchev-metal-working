...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto animate-fade-in">
        <div class="inline-flex items-center gap-2 mb-6 px-6 py-3 bg-accent-500/20 backdrop-blur-sm border-2 border-accent-500/60 rounded-sm shadow-lg shadow-accent-500/30">
            ...
            <span class="text-base font-bold text-accent-300 tracking-wide">{{ __('От 2015 година') }}</span>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="card card-hover group relative overflow-hidden">
                <div class="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                    <img src="{{ asset('metalworking-images/photo-1763926026024-2b294669e255.avif') }}" alt="{{ __('Материали') }}" class="w-full h-full object-cover">
                </div>
                <div class="relative z-10">
                    ...
                    <h3 class="text-xl font-bold text-white mb-3">{{ __('Всякакъв вид изработка') }}</h3>
                    <p class="text-slate-400 leading-relaxed">
                        {{ __('Всякакво желязо без титан. Изработваме детайли от всякакъв вид и сложност според вашите спецификации.') }}
                    </p>
                </div>
            </div>
            <div class="card card-hover group relative overflow-hidden">
                <div class="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                    <img src="{{ asset('metalworking-images/photo-1598302936625-6075fbd98dd7.avif') }}" alt="{{ __('Лазерно рязане') }}" class="w-full h-full object-cover">
                </div>
                <div class="relative z-10">
                    <div class="w-16 h-16 bg-accent-500/20 rounded-sm flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-accent-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-xl font-bold text-white mb-3">{{ __('Лазерно рязане') }}</h3>
                    <p class="text-slate-400 leading-relaxed">
                        {{ __('Прецизно лазерно рязане с модерно оборудване за високо качество.') }}
                    </p>
                </div>
            </div>
            <div class="card card-hover group relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h3 class="text-xl font-bold text-white mb-3">{{ __('Изработка на детайли') }}</h3>
                    <p class="text-slate-400 leading-relaxed">
            ...
            <div class="card card-hover group relative overflow-hidden">
                <div class="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                    <img src="{{ asset('images-crafting/IMG_3660.jpg') }}" alt="{{ __('Нишкова обработка') }}" class="w-full h-full object-cover">
                </div>
                <div class="relative z-10">
                    <div class="w-16 h-16 bg-accent-500/20 rounded-sm flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-accent-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-xl font-bold text-white mb-3">{{ __('Нишкова обработка') }}</h3>
                    <p class="text-slate-400 leading-relaxed">
            ...
            <div class="card card-hover group relative overflow-hidden">
                <div class="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                    <img src="{{ asset('images-crafting/IMG_3661.jpg') }}" alt="{{ __('Обемна ерозийна обработка') }}" class="w-full h-full object-cover">
                </div>
                <div class="relative z-10">
                    <div class="w-16 h-16 bg-accent-500/20 rounded-sm flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-accent-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-xl font-bold text-white mb-3">{{ __('Обемна ерозийна обработка') }}</h3>
                    <p class="text-slate-400 leading-relaxed">
            ...
            <div class="card card-hover group relative overflow-hidden">
                <div class="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                    <img src="{{ asset('images-crafting/IMG_3662.jpg') }}" alt="{{ __('Стругова обработка') }}" class="w-full h-full object-cover">
                </div>
                <div class="relative z-10">
                    <div class="w-16 h-16 bg-accent-500/20 rounded-sm flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-accent-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-xl font-bold text-white mb-3">{{ __('Стругова обработка') }}</h3>
                    <p class="text-slate-400 leading-relaxed">
            ...
            <div class="card card-hover group relative overflow-hidden">
                <div class="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                    <img src="{{ asset('images-crafting/IMG_3659.jpeg') }}" alt="{{ __('CNC обработка') }}" class="w-full h-full object-cover">
                </div>
                <div class="relative z-10">
                    <div class="w-16 h-16 bg-accent-500/20 rounded-sm flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-accent-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-xl font-bold text-white mb-3">{{ __('CNC обработка') }}</h3>
                    <p class="text-slate-400 leading-relaxed">
                        {{ __('Прецизна CNC обработка с модерни машини.') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <p class="text-lg text-slate-400 leading-relaxed mb-6">
                    {{ __('Специализирани сме в производството на военни компоненти и детайли с най-високи стандарти за качество и прецизност.') }}
                </p>
                <p class="text-lg text-slate-400 leading-relaxed mb-8">
                    {{ __('Нашият опит в тази област ни позволява да отговорим на най-строгите изисквания и спецификации.') }}
                </p>
                <div class="grid grid-cols-2 gap-6">
                    <div class="card card-hover text-center">
                        <div class="text-3xl font-bold text-accent-500 mb-2">{{ __('Високо качество') }}</div>
                        <p class="text-slate-400 text-sm">{{ __('Строг контрол') }}</p>
                    </div>
                    <div class="card card-hover text-center">
                        <div class="text-3xl font-bold text-accent-500 mb-2">{{ __('Прецизност') }}</div>
                        <p class="text-slate-400 text-sm">{{ __('Точност в детайла') }}</p>
                    </div>
                </div>
            </div>
            <div class="relative">
                <div class="aspect-square rounded-sm overflow-hidden border border-slate-800/50">
                    <img src="{{ asset('metalworking-images/premium_photo-1664303560361-2b31c2d2c0ba.avif') }}" alt="{{ __('Военна продукция') }}" class="w-full h-full object-cover">
                </div>
...
<section class="py-32 bg-slate-900 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-20">
            <h2 class="section-title">
                {{ __('Партньори, които ни се доверяват') }}
            </h2>
            <p class="section-subtitle">
                {{ __('Работим с водещи компании в различни индустрии') }}
            </p>
        </div>
