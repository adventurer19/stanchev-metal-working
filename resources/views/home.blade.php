...
@section('title', __('Станчев и Син | Прецизна металообработка Габрово'))
@section('description', __('Станчев и Син 2025 ЕООД - прецизна металообработка в Габрово. 15+ години опит в CNC обработка, фрезоване, стругова обработка. Високо качество и надеждност.'))
@section('keywords', __('Станчев и Син, металообработка Габрово, CNC обработка, фрезоване, стругова обработка, метални детайли'))
