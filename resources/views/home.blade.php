...
@section('title', __('Металообработка Габрово | Заваряване, ЦНЦ | Станчев и Син'))
@section('description', __('Прецизна металообработка в Габрово. 15+ години опит в заваряване, фрезоване, ЦНЦ обработка и производство на метални конструкции. Гарантирано качество.'))
@section('keywords', __('металообработка Габрово, заваряване, фрезоване, ЦНЦ обработка, метални конструкции, Станчев и Син'))
